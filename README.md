...
The naive encoding is a standard 4 byte integer array storing X_{l_1}X_{r_1} ... X_{l_n}X_{r_n} where X_{l_i}  and X_{r_i} is the righthand side of X_i -> X_{l_i}X_{r_i} and n is the number of non-terminals.
```
